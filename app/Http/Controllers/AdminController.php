...
class AdminController extends Controller
{
    ...
    public function dashboard_1()
    {
        ...
        $action = __FUNCTION__;
        session(['type' => \Auth::user()->type,'id' => \Auth::id(),'name' => \Auth::user()->name,'image' => \Auth::user()->image]);
    ...
    public function koki_element()
    {
        ...
        return view('dashboard.koki_element', compact('page_title', 'page_description','action','logo','logoText'));
    }
    ...
    public function order()
    {
        ...
        return view('dashboard.order', compact('page_title', 'page_description','action','logo','logoText'));
    }
	    // Order List
    public function order_list()
    {
        ...
        $action = __FUNCTION__;
        $user_id= \Auth::id();
        if($user_id==1){$orders = Orders::with('user')->get();}else{$orders = Orders::where('store_id',$user_id)->with('user')->get();}
        return view('dashboard.order_list', compact('orders','page_title', 'page_description','action','logo','logoText'));
    }
	    // Review
