									...
									<table id="example-5" class="display mb-4 dataTablesCard">
										...
										<tbody>
											<tr>
												...
												<td>$164.52</td>
												<td><a class="btn bgl-warning text-warning btn-sm">PENDING</a></td>
												<td>
											...
											<tr>
												...
												<td>$24.17	</td>
												<td><a class="btn bgl-light btn-sm">CANCLED</a></td>
												<td>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<tr>
												...
												<td>$22.18</td>
												<td><a class="btn bgl-success text-success  btn-sm">DELIVERED</a></td>
												<td>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<tr>
												...
												<td>$34.41</td>
												<td><a class="btn bgl-light btn-sm">CANCELED</a></td>
												<td>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<tr>
												...
												<td>$44.99</td>
												<td><a class="btn bgl-success text-success  btn-sm">DELEVIRED</a></td>
												<td>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
