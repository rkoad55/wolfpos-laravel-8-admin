					...
					<div class="col-xl-6 col-lg-12">
						<div class="card">
							<div class="card-header pb-0 border-0">
								...
								<div class="dropdown">
									<button type="button" class="btn border btn-rounded text-black dropdown-toggle" data-toggle="dropdown">
										Monthly
									</button>
								...
								<div class="table-responsive ">
									<table class="table order-request">
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="mr-3 img-fluid rounded-circle" width="75"  src="{{ asset('images/card/pic1.jpg') }}" alt="DexignZone">
													<div class="media-body">
											...
											<td>
												<div class="d-flex align-items-center">
													<a class="btn bgl-warning text-warning" href="javascript:;">PENDING</a>
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="mr-3 img-fluid rounded-circle" width="75"  src="{{ asset('images/card/pic2.jpg') }}" alt="DexignZone">
													<div class="media-body">
											...
											<td>
												<div class="d-flex align-items-center">
													<a class="btn bgl-success text-success" href="javascript:;">DELIVERED</a>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown">
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="12" cy="5" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="19" r="2"></circle></g></svg>
														</div>
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="mr-3 img-fluid rounded-circle" width="75"  src="{{ asset('images/card/pic3.jpg') }}" alt="DexignZone">
													<div class="media-body">
											...
											<td>
												<div class="d-flex align-items-center justify-content-center">
													<h4 class="mb-0 mr-3 fs-20 text-black d-inline-block">$4.2</h4>
													<p class="mb-0 fs-20 d-inline-block">x2</p>
												</div>
											</td>
											<td>
												<div class="d-flex align-items-center">
													<a class="btn bgl-light" href="javascript:;">CANCELED</a>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown">
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="12" cy="5" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="19" r="2"></circle></g></svg>
														</div>
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="mr-3 img-fluid rounded-circle" width="75"  src="{{ asset('images/card/pic6.jpg') }}" alt="DexignZone">
													<div class="media-body">
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="mr-3 img-fluid rounded-circle" width="75"  src="{{ asset('images/card/pic7.jpg') }}" alt="DexignZone">
													<div class="media-body">
														<h5 class="mt-0 mb-2"><a href="{!! url('/ecom-product-detail'); !!}" class="text-black">Mozarella Pizza With Random Topping</a></h5>
														<p class="mb-0 text-primary">#0010299</p>
													</div>
