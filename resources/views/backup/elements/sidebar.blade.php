<div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{!! url('/koki-element'); !!}">Koki Element</a></li>
						</ul>
                    </li>
				...
				<div class="copyright">
					<p class="fs-14 font-w200"><strong class="font-w400">Koki Restaurant Admin Dashboard</strong> © 2020 All Rights Reserved</p>
					<p>Made with <i class="fa fa-heart"></i> by Insitech</p>
				</div>
			</div>
        </div>