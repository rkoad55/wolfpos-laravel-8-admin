    ...
    <div class="card-body pad">
        ...
        <div class="row">
          <div class="form-group col-md-12">
            ...
            <input type="text" name="name" value="{{old('name', isset($addons)?$addons->name:'')}}" class="form-control input-default" id="title" placeholder="Title " >
...
@endif
    ...
    <div class="form-group col-md-12">
        ...
        <div class="input-group mb-3  input-primary">
                                            ...
                                            <input type="number" class="form-control" name="price" value="{{old('price', isset($addons)?$addons->price:'')}}" >
    ...
    <div class="form-group col-md-12">
        ...
        <?php if(isset($addons)){ ?><img src="{{asset($addons->image)}}" width="200"/><?php } ?>
        @if ($errors->has('image'))
...
@endif
   ...
   <div class="form-group has-feedback col-md-12{{ $errors->has('status') ? ' has-error' : '' }}">
        ...
        {!! Form::select('status', ['1' => 'Enable', '0' => 'Disable'] , isset($addons->status) && $addons->status == $addons->status ? $addons->status : 1, ['class'=>'form-control', '']) !!}
