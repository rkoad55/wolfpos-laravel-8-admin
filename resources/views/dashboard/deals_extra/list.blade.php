...
<div class="alert alert-success alert-dismissible fade show">
                        ...
                        <strong>Success!</strong> Deal Extra Deleted Successfully.
...
@endif
              ...
              <div class="card-tools">
                ...
                <a href="{{ url('/dealsExtra/create') }}" class="fcbtn btn btn-outline btn-primary btn-1b">Add Deal Extra</a>
...
@foreach($dealsExtra as $key => $value)
...
<tr id="row_{{$value->id}}">
  ...
  <div class="dropdown ml-auto">
		...
		<div class="dropdown-menu dropdown-menu-right">
			...
			<a class="dropdown-item text-black" href="{{ url('/dealsExtra/'.$value->id.'/edit') }}">
			<svg class="mr-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="modal fade" id="basicModal{{$value->id}}">
										...
										<form  method="POST" action="{{ url('/dealsExtra/delete') }}">
                      						@csrf
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">Are You Sure You Want To Delete This Deal Extra.</div>
