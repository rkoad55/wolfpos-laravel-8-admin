...
@endif
              ...
              <div class="card-tools">
                ...
                <a href="{{ url('/products/create') }}" class="fcbtn btn btn-outline btn-primary btn-1b">Add Product</a>
									...
									<table id="example-5" class="display mb-4 dataTablesCard">
										<thead>
                                            <tr>
                                                ...
                                                <th><strong class="font-w600 wspace-no">Product Code</strong></th>
...
<td>{{$value->product_code}}</td>
  ...
  <div class="dropdown ml-auto">
        ...
        <form  method="POST" action="{{ url('/addons/show') }}">
                      						@csrf
			...
			<a class="dropdown-item text-black" href="{{ url('/products/'.$value->id.'/edit') }}">
			<svg class="mr-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
