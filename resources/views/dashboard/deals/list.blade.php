...
<div class="alert alert-success alert-dismissible fade show">
                        ...
                        <strong>Success!</strong> Deal Deleted Successfully.
...
@endif
              ...
              <div class="card-tools">
                ...
                <a href="{{ url('/deals/create') }}" class="fcbtn btn btn-outline btn-primary btn-1b">Add Deal</a>
									...
									<table id="example-5" class="display mb-4 dataTablesCard">
										<thead>
                                            <tr>
                                                ...
                                                <th><strong class="font-w600 wspace-no">Deal Code</strong></th>
                                                <th><strong class="font-w600 wspace-no">Name</strong></th>
                                                <th><strong class="font-w600 wspace-no">Products</strong></th>
                                                <!-- <th><strong class="font-w600 wspace-no">Availability</strong></th> -->
                                                <th><strong class="font-w600 wspace-no">Price</strong></th>
                                                <!-- <th><strong class="font-w600 wspace-no">Sale Price</strong></th> -->
...
<td>{{$value->deal_code}}</td>
  ...
  <div class="dropdown ml-auto">
        ...
        <form  method="POST" action="{{ url('/dealsExtra/show') }}">
                      						@csrf
                                              <input type="hidden" name="dealsExtra_id" value="{{$value->id}}"/>
			 <button class="dropdown-item text-black" type="submit">
			...
			<a class="dropdown-item text-black" href="{{ url('/deals/'.$value->id.'/edit') }}">
			<svg class="mr-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="modal fade" id="basicModal{{$value->id}}">
										...
										<form  method="POST" action="{{ url('/deals/delete') }}">
                      						@csrf
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">Are You Sure You Want To Delete This Deal.</div>
												<input type="hidden" name="deal_id" value="{{$value->id}}"/>
