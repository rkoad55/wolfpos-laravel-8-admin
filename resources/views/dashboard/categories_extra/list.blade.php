...
<div class="alert alert-success alert-dismissible fade show">
                        ...
                        <strong>Success!</strong> Category Extra Deleted Successfully.
...
@endif
              ...
              <div class="card-tools">
                ...
                <a href="{{ url('/categoriesExtra/create') }}" class="fcbtn btn btn-outline btn-primary btn-1b">Add Extra</a>
					...
					<div class="col-xl-12">
								<div class="table-responsive">
									<table id="example-5" class="display mb-4 dataTablesCard">
										...
										<tbody>
                    @if(count($categoriesExtra))

@foreach($categoriesExtra as $key => $value)
...
<tr id="row_{{$value->id}}">
  ...
  <div class="dropdown ml-auto">
		...
		<div class="dropdown-menu dropdown-menu-right">
			...
			<a class="dropdown-item text-black" href="{{ url('/categoriesExtra/'.$value->id.'/edit') }}">
			<svg class="mr-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="modal fade" id="basicModal{{$value->id}}">
										...
										<form  method="POST" action="{{ url('/categoriesExtra/delete') }}">
                      						@csrf
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">Are You Sure You Want To Delete This Category Extra.</div>
