			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 mb-md-5 align-items-start">
					...
					<div class="dropdown ml-auto">
						<div class="btn btn-primary btn-rounded dropdown-toggle d-block  px-4" data-toggle="dropdown">
							<svg class="mr-2 scale5" width="14" height="14" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<div class="card-body rounded" style="background:#3f4953;">
										<div class="row mx-0 align-items-center">
											<div class="media align-items-center col-md-4 col-lg-6 px-0 mb-3 mb-md-0">
												<img class="mr-3 img-fluid rounded-circle" width="100"  src="{{ asset('images/profile/5.png') }}" alt="DexignZone">
										...
										<div class="table-responsive order-list">
											<table class="table items-table">
												...
												<tr>
													<td>
														<div class="media">
															<a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded" width="85"  src="{{ asset('images/card/pic5.jpg') }}" alt="DexignZone"></a>
															<div class="media-body">
																<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
																<h5 class="mt-0 mb-2 mb-4"><a class="text-black" href="ecom-product-detail.html">Watermelon juice with ice</a></h5>
												...
												<tr>
													<td>
														<div class="media">
															<a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded" width="85"  src="{{ asset('images/card/pic6.jpg') }}" alt="DexignZone"></a>
															<div class="media-body">
																<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
																<h5 class="mt-0 mb-2 text-black mb-4"><a class="text-black" href="ecom-product-detail.html">Chicken curry special with cucumber</a></h5>
																<div class="star-review fs-14">
																	<i class="fa fa-star text-orange"></i>
																	<i class="fa fa-star text-orange"></i>
																	<i class="fa fa-star text-orange"></i>
												...
												<tr>
													<td>
														<div class="media">
															<a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded" width="85"  src="{{ asset('images/card/pic7.jpg') }}" alt="DexignZone"></a>
															<div class="media-body">
																<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
								...
								<div class="card">
									<div class="card-body border-bottom">
										<div class="media align-items-center">
											<img class="mr-3 rounded-circle"  src="{{ asset('images/profile/6.jpg') }}" width="90" alt="">
											<div class="media-body">
							...
							<div class="col-xl-12 col-md-6 col-xxl-6">
								<div class="card">
									<div class="card-header border-0">
										<h4 class="text-black font-w600 wspace-no">Customer Favourite</h4>
									</div>
