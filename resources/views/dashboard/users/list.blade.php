...
@endif
              ...
              <div class="card-tools">
                ...
                <a href="{{ url('/users/create') }}" class="fcbtn btn btn-outline btn-primary btn-1b">Add User</a>
									...
									<table id="example-5" class="display mb-4 dataTablesCard">
										<thead>
                                            <tr>
                                                ...
                                                <th><strong class="font-w600 wspace-no">Type </strong></th>
                                                <th><strong class="font-w600 wspace-no">Master Name</strong></th>
...
<td>{{$value->name}}</td>
  <td>{{$value->email}}</td>
  <td>{{ $value->type}}</td>
  <td>@if($value->user != null) {{ $value->user->name}}  @endif </td>
  ...
  @if($value->status == 1)
      ...
      <button type="button" style="width: 112%;" class="fcbtn btn btn-info btn-outline btn-1d"> Active </button>
  ...
  <div class="dropdown ml-auto">
		...
		<div class="dropdown-menu dropdown-menu-right">
			...
			<a class="dropdown-item text-black" href="{{ url('/users/'.$value->id.'/edit') }}">
			<svg class="mr-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
