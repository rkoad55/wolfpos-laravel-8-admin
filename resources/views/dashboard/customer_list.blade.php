									...
									<table id="example-5" class="display mb-4 dataTablesCard">
										...
										<tbody>
											<tr>
												...
												<td>£164.52</td>
												<td><a href="#" class="btn bgl-light text-black btn-sm">£14.89</a></td>
												<td>
											...
											<tr>
												...
												<td>£74.92</td>
												<td><a href="#" class="btn bgl-light text-black btn-sm">£8.13</a></td>
												<td>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown" aria-expanded="false">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<tr>
												...
												<td>£251.16</td>
												<td><a href="#" class="btn bgl-light text-black btn-sm">£21.55</a></td>
												<td>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown" aria-expanded="false">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<tr>
												...
												<td>£82.46</td>
												<td><a href="#" class="btn bgl-light text-black btn-sm">£42.85</a></td>
												<td>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown" aria-expanded="false">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<tr>
												...
												<td>£24.17	</td>
												<td><a href="#" class="btn bgl-light text-black btn-sm">£11.41</a></td>
												<td>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown" aria-expanded="false">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<tr>
												...
												<td>£24.55	</td>
												<td><a href="#" class="btn bgl-light text-black btn-sm">£67.27</a></td>
												<td>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown" aria-expanded="false">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<tr>
												<td class="sorting_1 p-0 text-center">
													<div class="custom-control custom-checkbox ml-2">
														<input type="checkbox" class="custom-control-input" id="customCheckBox33" required="">
												...
												<td>£45.86</td>
												<td><a href="#" class="btn bgl-light text-black btn-sm">£91.68</a></td>
												<td>
													<div class="dropdown ml-auto">
														<div class="btn-link" data-toggle="dropdown" aria-expanded="false">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<tr>
												<td class="sorting_1 p-0 text-center">
													<div class="custom-control custom-checkbox ml-2">
														<input type="checkbox" class="custom-control-input" id="customCheckBox44" required="">
											...
											<tr>
												<td class="sorting_1 p-0 text-center">
													<div class="custom-control custom-checkbox ml-2">
														<input type="checkbox" class="custom-control-input" id="customCheckBox66" required="">
